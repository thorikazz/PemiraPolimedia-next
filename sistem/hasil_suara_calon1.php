...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Aplikasi E-Voting Pemilihan Mahasiswa Raya PoliMedia 2020. Selamat datang di sistem E-voting online berbasis web.">
    <meta name="keywords" content="E-Voting, PoliMedia, MPM, BEM, HIMA">
    <meta name="author" content="Divisi IT PEMIRA 2020, Authentic Tech">
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										<div class="photo">
											...
											<img src="foto/bph_mpm/<?= $d['foto']; ?>" alt="default" data-toggle="modal" data-target="#myModal>" class="model_img img-responsive" />
										</div>
										<div class="info">
                                            ...
                                            <?php 
                                            $no_urut = $d['no_urut'];
                                            $dtotal_suara = mysqli_query($koneksi, "SELECT * FROM tbl_pemilih WHERE pilihan1 = $no_urut");
