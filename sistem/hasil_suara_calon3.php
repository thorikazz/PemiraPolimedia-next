	...
	<div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Ketua & Wakil BEM</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
				...
				$kolom = 0;
                $proses = false;
				$data_calon_bem = mysqli_query($koneksi, "SELECT * FROM calon_bem ORDER BY no_urut ASC");
				while ($d = mysqli_fetch_array($data_calon_bem)) {
				?>
					<?php $kolom++;
					if ($kolom == 1) {
						echo "<div class='row'>";
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										...
										<div class="info">
                                            ...
                                            <?php 
                                            $no_urut = $d['no_urut'];
                                            $dtotal_suara = mysqli_query($koneksi, "SELECT * FROM tbl_pemilih WHERE pilihan3 = $no_urut");
