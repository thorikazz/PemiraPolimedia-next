	...
	<div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Ketua & Wakil HIMA</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
				...
				$kolom = 0;
                $proses = false;
				$data_calon_hima = mysqli_query($koneksi, "SELECT * FROM calon_hima");
				while ($d = mysqli_fetch_array($data_calon_hima)) {
				?>
					<?php $kolom++;
					if ($kolom == 1) {
						echo "<div class='row'>";
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										...
										<div class="info">
                                            ...
                                            $no_urut = $d['no_urut'];
                                            if ($jurusan == 'Teknik') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi='Teknik Grafika' OR prodi='Teknik Kemasan' OR prodi='Teknik Perbaikan Mesin')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Penerbitan') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Penerbitan')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Periklanan') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Periklanan')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Penyiaran') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Penyiaran')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Fotografi') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Fotografi')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Desain Grafis') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Desain Grafis')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Desain Mode') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Desain Mode')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Teknologi Rekayasa Multimedia') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Teknologi Rekayasa Multimedia')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Animasi') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Animasi')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Teknologi Permainan') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Teknologi Permainan')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Perhotelan') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Perhotelan')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Seni Kuliner') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Seni Kuliner')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            } elseif ($prodi == 'Film dan Televisi') {
                                                $cari_data = "SELECT * FROM tbl_pemilih WHERE pilihan4 = $no_urut AND (prodi = 'Film dan Televisi')";
                                                $dtotal_suara = mysqli_query($koneksi, $cari_data);
                                                echo $total_suara = mysqli_num_rows($dtotal_suara);
                                            }
                                            ?>
