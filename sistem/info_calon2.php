	...
	<div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="page-wrapper">
			<div class="container-fluid">
				...
				$kolom = 0;
				$proses = false;
				$data_calon_anggota_mpm = mysqli_query($koneksi, "SELECT * FROM calon_anggota_mpm WHERE NOT nama = '-'");
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										<div class="photo">
											...
											<img src="foto/anggota_mpm/<?php echo $d['foto']; ?>" alt="default" data-toggle="modal" data-target="#myModal<?= $d['id']; ?>" class="model_img img-responsive" />
										</div>
										<div class="info">
