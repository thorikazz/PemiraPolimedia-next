	...
	<div class="wrapper theme-6-active pimary-color-pink">
		...
		<div class="page-wrapper">
			<div class="container-fluid">
				...
				$kolom = 0;
				$proses = false;
				$data_calon_ketua_dan_wakil_hima = mysqli_query($koneksi, "SELECT * FROM calon_hima");
								...
								<div class="panel-body pa-0">
									<article class="col-item">
										<div class="photo">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<br>
															<?php endif; ?>
															<p><?php if ($d['prodi'] == "Teknik Kemasan" || $d['prodi'] == "Teknik Grafika" || $d['prodi'] == "Teknik Mesin") : ?>
																	<?php echo "Jurusan:"; ?>
																<?php else : ?>
																	<?php echo "Prodi:"; ?>
																<?php endif; ?>
																<?php if ($d['prodi'] == "Teknik Kemasan" || $d['prodi'] == "Teknik Grafika" || $d['prodi'] == "Teknik Mesin") : ?>
																	<?php echo $d['jurusan']; ?>
																<?php else : ?>
																	<?php echo $d['prodi']; ?>
																<?php endif; ?></p>														
											...
											<img src="foto/hima/<?= $d['foto']; ?>" alt="default" data-toggle="modal" data-target="#myModal<?= $d['id']; ?>" class="model_img img-responsive" />
										</div>
										<div class="info">
											<h6><?= $d['nama_ketua']; ?></h6>
											<?php if (!empty($d['nama_wakil_1'])) : ?>
