						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form action="aksi_insert_calon_bem.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select name="prodi_ketua" class="form-control" data-placeholder="Choose a Category" tabindex="1">
											...
											<!--/row-->
											<div class="seprator-block"></div>
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>biodata wakil ketua</h6>
											<hr class="light-grey-hr" />
											<!-- Row -->
											<div class="row">
												<!--Span-->
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Nama</label>
														<input required="" type="text" name="nama_wakil" id="nama_wakil" class="form-control" placeholder="nama">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">NIM</label>
														<input required="" type="text" name="nim_wakil" id="nim_wakil" class="form-control" placeholder="NIM">
													</div>
												</div>
												<!--/span-->
											</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Tempat Tanggal Lahir</label>
														<input required="" type="text" name="ttl_wakil" id="ttl_wakil" class="form-control" placeholder="tempat tanggal lahir">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="radio-list">
															<div class="radio-inline pl-0">
																<div class="radio radio-info">
																	<input required="" type="radio" name="jenis_kelamin_wakil" id="jenis_kelamin_wakila" value="Laki-laki">
																	<label for="jenis_kelamin_wakila">Laki-laki</label>
																</div>
															</div>
															<div class="radio-inline">
																<div class="radio radio-info">
																	<input required="" type="radio" name="jenis_kelamin_wakil" id="jenis_kelamin_wakilb" value="Perempuan">
																	<label for="jenis_kelamin_wakilb">Perempuan</label>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Prodi</label>
														<select name="prodi_wakil" class="form-control" data-placeholder="Choose a Category" tabindex="1">
															<option value="Teknik Grafika">Teknik Grafika</option>
															<option value="Teknik Kemasan">Teknik Kemasan</option>
															<option value="Teknik Mesin">Teknik Mesin</option>
															<option value="Penerbitan">Penerbitan</option>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Semester</label>
														<select name="semester_wakil" class="form-control" data-placeholder="Choose a Category" tabindex="1">
															<option value="1">1</option>
															<option value="3">3</option>
															<option value="5">5</option>
														</select>
