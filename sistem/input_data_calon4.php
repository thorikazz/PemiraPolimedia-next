				...
				?>
					...
					<li>
						...
						<ul id="input_data_calon" class="collapse collapse-level-1">
							...
							<li>
								<a class="active" href="#">Ketua & Wakil HIMA</a>
							</li>
						</ul>
					</li>
					<li>
			...
			<div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h5 class="txt-dark">Ketua & Wakil Ketua HIMA</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Ketua & Wakil Ketua HIMA</span></li>
						</ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="form-wrap">
										<form action="aksi_insert_calon_hima.php" method="post" enctype="multipart/form-data">
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-collection-image mr-10"></i>foto</h6>
											<hr class="light-grey-hr" />
											<!-- Row -->
											<div class="row">
												<div class="col-lg-12">
													<input required="" type="file" name="foto" class="form-control-file">
												</div>
											</div>
											<!-- /row -->
											<div class="seprator-block"></div>
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>biodata ketua</h6>
											<hr class="light-grey-hr" />
											<!-- Row -->
											<div class="row">
												<!--/span-->
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required="" type="text" name="nama_ketua" id="nama_ketua" class="form-control" placeholder="nama">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">NIM</label>
														<input required="" type="text" name="nim_ketua" id="nim_ketua" class="form-control" placeholder="NIM">
													</div>
												</div>
												<!--/span-->
											</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input required="" type="text" name="ttl_ketua" id="ttl_ketua" class="form-control" placeholder="tempat tanggal lahir">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="radio-list">
															<div class="radio-inline pl-0">
																<div class="radio radio-info">
																	<input required="" type="radio" name="jenis_kelamin_ketua" id="jenis_kelamin_ketuaa" value="Laki-laki">
																	<label for="jenis_kelamin_ketuaa">Laki-laki</label>
																</div>
															</div>
															<div class="radio-inline">
																<div class="radio radio-info">
																	<input required="" type="radio" name="jenis_kelamin_ketua" id="jenis_kelamin_ketuab" value="Perempuan">
																	<label for="jenis_kelamin_ketuab">Perempuan</label>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select name="semester_ketua" class="form-control" data-placeholder="Choose a Category" tabindex="1">
											...
											<!--/row-->
											<div class="seprator-block"></div>
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>biodata wakil ketua 1</h6>
											<hr class="light-grey-hr" />
											<!-- Row -->
											<div class="row">
												<!--Span-->
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Nama</label>
														<input type="text" name="nama_wakil_1" id="nama_wakil_1" class="form-control" placeholder="nama">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">NIM</label>
														<input type="text" name="nim_wakil_1" id="nim_wakil_1" class="form-control" placeholder="NIM">
													</div>
												</div>
												<!--/span-->
											</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Tempat Tanggal Lahir</label>
														<input type="text" name="ttl_wakil_1" id="ttl_wakil_1" class="form-control" placeholder="tempat tanggal lahir">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="radio-list">
															<div class="radio-inline pl-0">
																<div class="radio radio-info">
																	<input type="radio" name="jenis_kelamin_wakil_1" id="jenis_kelamin_wakil_1a" value="Laki-laki">
																	<label for="jenis_kelamin_wakil_1a">Laki-laki</label>
																</div>
															</div>
															<div class="radio-inline">
																<div class="radio radio-info">
																	<input type="radio" name="jenis_kelamin_wakil_1" id="jenis_kelamin_wakil_1b" value="Perempuan">
																	<label for="jenis_kelamin_wakil_1b">Perempuan</label>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Semester</label>
														<select name="semester_wakil_1" class="form-control" data-placeholder="Choose a Category" tabindex="1">
															<option value="1">1</option>
															<option value="3">3</option>
															<option value="5">5</option>
														</select>
											...
											<!--/row-->
											<div class="seprator-block"></div>
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>biodata wakil ketua 2</h6>
											<hr class="light-grey-hr" />
											<!--Row-->
											<div class="row">
												<!--Span-->
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Nama</label>
														<input type="text" name="nama_wakil_2" id="nama_wakil_2" class="form-control" placeholder="nama">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">NIM</label>
														<input type="text" name="nim_wakil_2" id="nim_wakil_2" class="form-control" placeholder="NIM">
													</div>
												</div>
												<!--/span-->
											</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Tempat Tanggal Lahir</label>
														<input type="text" name="ttl_wakil_2" id="ttl_wakil_2" class="form-control" placeholder="tempat tanggal lahir">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="radio-list">
															<div class="radio-inline pl-0">
																<div class="radio radio-info">
																	<input type="radio" name="jenis_kelamin_wakil_2" id="jenis_kelamin_wakil_2a" value="Laki-laki">
																	<label for="jenis_kelamin_wakil_2a">Laki-laki</label>
																</div>
															</div>
															<div class="radio-inline">
																<div class="radio radio-info">
																	<input type="radio" name="jenis_kelamin_wakil_2" id="jenis_kelamin_wakil_2b" value="Perempuan">
																	<label for="jenis_kelamin_wakil_2b">Perempuan</label>
																</div>
															</div>
														</div>
													</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label mb-10">Semester</label>
														<select name="semester_wakil_2" class="form-control" data-placeholder="Choose a Category" tabindex="1">
															<option value="1">1</option>
															<option value="3">3</option>
															<option value="5">5</option>
														</select>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select name="prodi" class="form-control" data-placeholder="Choose a Category" tabindex="1">
															...
															<option value="Teknik Perbaikan Mesin">Teknik Perbaikan Mesin</option>
											...
											<!--/row-->
											<div class="seprator-block"></div>
											<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-comment-text mr-10"></i>Visi & Misi</h6>
											<hr class="light-grey-hr" />
											<!-- Row -->
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														<textarea name="visi_dan_misi" class="form-control" rows="4"></textarea>
													</div>
												</div>
											</div>
											<!--/row-->
											<div class="form-actions">
												<button type="submit" name="simpan" class="btn btn-success btn-icon left-icon mr-10 pull-left"> <i class="fa fa-check"></i> <span>Simpan</span></button>
